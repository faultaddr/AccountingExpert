...
final class CalendarViewDelegate {
    ...
    private int mCurDayTextColor,
            ...
            mSelectedDetailTextColor,
            mCurMonthLunarTextColor,
            mCurMonthDetailTextColor,
            mOtherMonthLunarTextColor,
            mOtherMonthDetailTextColor;
     ...
     * 日期和农历文本大小
     */
    private int mDayTextSize, mLunarTextSize, mDetailTextSize;
    ...
    CalendarViewDelegate(Context context, @Nullable AttributeSet attrs) {
        ...
        mCurDayDetailTextColor = array.getColor(R.styleable.CalendarView_current_day_detail_text_color, Color.RED);
        ...
        mSelectedDetailTextColor = array.getColor(R.styleable.CalendarView_selected_lunar_text_color, 0xFF111111);
        ...
        mCurMonthDetailTextColor = array.getColor(R.styleable.CalendarView_current_month_detail_text_color, 0xffe1e1e1);
        mOtherMonthLunarTextColor = array.getColor(R.styleable.CalendarView_other_month_lunar_text_color, 0xffe1e1e1);
        mOtherMonthDetailTextColor = array.getColor(R.styleable.CalendarView_current_month_detail_text_color, 0xffe1e1e1);
        ...
        mDetailTextSize = array.getDimensionPixelSize(R.styleable.CalendarView_detail_text_size,
                CalendarUtil.dipToPx(context, 10));
...
//        }
    ...
    int getCurDayDetailTextColor() {
        return mCurDayDetailTextColor;
    }
    ...
    int getSelectedDetailTextColor() {
        return mSelectedDetailTextColor;
    }
    int getCurrentMonthLunarTextColor() {
        return mCurMonthLunarTextColor;
    }

    int getCurrentMonthDetailTextColor() {
        return mCurMonthDetailTextColor;
    }
    ...
    int getOtherMonthDetailTextColor() {
        return mOtherMonthDetailTextColor;
    }

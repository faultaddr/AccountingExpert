...
public abstract class BaseView extends View implements View.OnClickListener, View.OnLongClickListener {
    ...
    protected Paint mCurMonthDetailTextPaint = new Paint();
    ...
    protected Paint mSelectedDetailPaint = new Paint();
    ...
    protected Paint mOtherMonthDetailTextPaint = new Paint();
    ...
    protected Paint mCurDayDetailInfoTextPaint = new Paint();
    ...
    private void initPaint(Context context) {
        ...
        mCurMonthDetailTextPaint.setAntiAlias(true);
        mCurMonthDetailTextPaint.setTextAlign(Paint.Align.CENTER);

        mSelectedLunarTextPaint.setAntiAlias(true);
        mSelectedLunarTextPaint.setTextAlign(Paint.Align.CENTER);

        mSelectedDetailPaint.setAntiAlias(true);
        mSelectedDetailPaint.setTextAlign(Paint.Align.CENTER);

        mOtherMonthLunarTextPaint.setAntiAlias(true);
        mOtherMonthLunarTextPaint.setTextAlign(Paint.Align.CENTER);

        mOtherMonthDetailTextPaint.setAntiAlias(true);
        mOtherMonthDetailTextPaint.setTextAlign(Paint.Align.CENTER);
        ...
        mCurDayDetailInfoTextPaint.setAntiAlias(true);
        mCurDayDetailInfoTextPaint.setTextAlign(Paint.Align.CENTER);
        mCurDayDetailInfoTextPaint.setColor(Color.RED);
        mCurDayDetailInfoTextPaint.setFakeBoldText(true);
        mCurDayDetailInfoTextPaint.setTextSize(CalendarUtil.dipToPx(context, TEXT_SIZE));
    ...
    final void updateStyle() {
        ...
        this.mCurDayDetailInfoTextPaint.setColor(mDelegate.getCurDayDetailTextColor());
        ...
        this.mCurMonthDetailTextPaint.setColor(mDelegate.getCurrentMonthDetailTextColor());
        this.mSelectedLunarTextPaint.setColor(mDelegate.getSelectedLunarTextColor());
        this.mSelectedDetailPaint.setColor(mDelegate.getSelectedDetailTextColor());
        ...
        this.mOtherMonthDetailTextPaint.setColor(mDelegate.getOtherMonthDetailTextColor());
        ...
        this.mCurMonthDetailTextPaint.setTextSize(mDelegate.getDetailTextSize());
        this.mSelectedLunarTextPaint.setTextSize(mDelegate.getLunarTextSize());
        this.mSelectedDetailPaint.setTextSize(mDelegate.getDetailTextSize());
        this.mCurDayLunarTextPaint.setTextSize(mDelegate.getLunarTextSize());
        this.mCurDayDetailInfoTextPaint.setTextSize(mDelegate.getDetailTextSize());
        this.mOtherMonthLunarTextPaint.setTextSize(mDelegate.getLunarTextSize());
        this.mOtherMonthDetailTextPaint.setTextSize(mDelegate.getDetailTextSize());

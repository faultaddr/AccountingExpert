...
internal class GridRVAdapter(
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View? {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater!!.inflate(R.layout.custom_grid_dialog_item, null)
        }
        // on below line we are initializing our course image view
        // and course text view with their ids.
        courseIV = convertView!!.findViewById(R.id.grid_item_image)
        courseTV = convertView!!.findViewById(R.id.grid_item_text)
